    ...
    <section className="py-20 bg-blue-light">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-serif font-medium mb-6 max-w-2xl mx-auto">
          Gatavi iemūžināt jūsu ģimenes īpašos mirkļus?
        </h2>
        <p className="text-lg mb-10 max-w-2xl mx-auto text-muted-foreground">
          Pievienojieties tūkstošiem ģimeņu, kas atradušas savu ideālo fotogrāfu ar Kindred palīdzību.
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button asChild size="lg">
            <Link to="/search">
              Atrodiet savu fotogrāfu
            </Link>
          </Button>
